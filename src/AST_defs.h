...
known_cst new_known_cst(region r, location loc, cval cval);
...
struct AST_type_variable { /* extends type_element */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_breakable_stmt { /* extends statement */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_conditional_stmt { /* extends breakable_stmt */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_for_stmt { /* extends breakable_stmt */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_assert_type_stmt { /* extends statement */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_change_type_stmt { /* extends statement */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_deep_restrict_stmt { /* extends statement */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
struct AST_array_ref { /* extends binary */
  ast_kind kind;
  location loc;
  node sameregion next;
  node sameregion parent;
...
#define scan_type_variable(var, list) for (var = (list); var; var = CAST(type_variable, var->next))
...
#define scan_user_qual(var, list) for (var = (list); var; var = CAST(user_qual, var->next))
...
#define scan_breakable_stmt(var, list) for (var = (list); var; var = CAST(breakable_stmt, var->next))
...
#define scan_assert_type_stmt(var, list) for (var = (list); var; var = CAST(assert_type_stmt, var->next))
change_type_stmt change_type_stmt_chain(change_type_stmt l1, change_type_stmt l2);
#define scan_change_type_stmt(var, list) for (var = (list); var; var = CAST(change_type_stmt, var->next))
deep_restrict_stmt deep_restrict_stmt_chain(deep_restrict_stmt l1, deep_restrict_stmt l2);
#define scan_deep_restrict_stmt(var, list) for (var = (list); var; var = CAST(deep_restrict_stmt, var->next))
