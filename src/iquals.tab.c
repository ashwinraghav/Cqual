/* A Bison parser, made from iquals.y
   by GNU bison 1.35.  */
...
{
       0,     0,     1,     4,     8,    12,    16,    24,    26
};
static const short yyrhs[] =
{
      -1,    11,    10,     0,    12,     7,    12,     0,    12,     5,
      12,     0,    12,     8,    12,     0,    12,     7,    12,     6,
      12,     7,    12,     0,     3,     0,     4,     0
};
...
{
  "$", "error", "$undefined.", "CONSTANT", "VARIABLE", "EQ", "IMPLIES", 
  "LEQ", "UNIFY", "ERROR", "system", "constraint", "qualifier", 0
};
#endif
...
{
       0,-32768,-32768,     0,     2,-32768,     0,     0,     0,-32768,
      -1,-32768,     0,     4,     0,-32768,    12,    13,-32768
};
...
{
       9,    10,    11,     1,     2,    12,    13,     6,    15,     7,
       8,    14,    17,    18,    16
};

static const short yycheck[] =
{
       6,     7,     8,     3,     4,     6,    12,     5,    14,     7,
       8,     7,     0,     0,     0
};
...
#line 53 "iquals.y"
{
	      if (mkleq_qual(NULL, yyvsp[-2].qual, yyvsp[0].qual))
		{
...
#line 61 "iquals.y"
{
	      if (mkeq_qual(NULL, yyvsp[-2].qual, yyvsp[0].qual))
		{
		  yyerror("Unsatisfiable constraint");
		  YYABORT;
		}
...
#line 69 "iquals.y"
{
	      if (unify_qual(NULL, yyvsp[-2].qual, yyvsp[0].qual))
		{
		  yyerror("Unsatisfiable constraint");
		  YYABORT;
		}
...
#line 77 "iquals.y"
{
	      if (cond_mkleq_qual(NULL, yyvsp[-6].qual, yyvsp[-4].qual, yyvsp[-2].qual, yyvsp[0].qual))
		{
		  yyerror("Unsatisfiable constraint");
		  YYABORT;
		}
...
case 7:
#line 85 "iquals.y"
{ yyval.qual = find_qual(yyvsp[0].str);
                      if (!yyval.qual)
			{
			  yyerror("Unknown qualifier %s", yyvsp[0].str);
			  YYABORT;
			}
                    ;
    break;}
case 8:
#line 92 "iquals.y"
{ yyval.qual = lookup_add_var(yyvsp[0].str); ;
    break;}
}
