...
DIST_COMMON = README COPYING Makefile.am Makefile.in aclocal.m4 \
	configure configure.in inst/depcomp inst/install-sh \
	inst/missing inst/mkinstalldirs inst/texinfo.tex inst/ylwrap
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkinstalldirs) $(distdir)/bin $(distdir)/config $(distdir)/examples $(distdir)/inst
